        ...
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-2 text-white/90 font-medium">
                    <li><span class="font-semibold">Mondays:</span> 9AM – 7PM</li>
                ...
                <h2 class="text-2xl font-bold mt-10 mb-4">Pre Order Sekarang</h2>
            ...
            {{-- ===== Right: Google Map ===== --}}
            <div>
                <h2 class="text-2xl font-bold mb-6">Lokasi Outlet Kami</h2>
