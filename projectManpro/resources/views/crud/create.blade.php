...
<section class="relative absolute bg-cover min-h-screen flex items-center justify-center"
    ...
    <div class="relative z-10 bg-[#FFFFFF]/20 backdrop-blur-md text-white p-10 rounded-2xl shadow-2xl w-full max-w-md border border-gray-700">
        ...
        <!-- Form -->
        <form id="menuForm" action="{{ route('menu.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            <div class="flex justify-between mt-8">
                <a href="/menu" class="bg-[#1E1E3A] hover:bg-[#16162e] text-white font-semibold px-6 py-2 rounded-lg transition">
                    Kembali
                </a>
                <button type="submit"
